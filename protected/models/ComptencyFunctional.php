...
class ComptencyFunctional extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('funct_name', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('funct_id, funct_name, function_status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('funct_id',$this->funct_id);
		$criteria->compare('funct_name',$this->funct_name,true);
