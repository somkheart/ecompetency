...
class DepartmentController extends Controller {
    ...
    public function actionLoadDivision($group_id) {
        ...
        echo CHtml::activeDropDownList($model, 'department_id', CHtml::listData(Department::model()->findAllByAttributes(array('group_id' => $group_id)), 'department_id', 'department_name'), array('class'=>'k-input','style'=>'width:350px','empty' => '---- เลือก ----'));
    }
